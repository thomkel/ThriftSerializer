...
public class PersonPropertyValue extends org.apache.thrift.TUnion<PersonPropertyValue, PersonPropertyValue._Fields> {
  ...
  private static final org.apache.thrift.protocol.TField BIRTHDATE_FIELD_DESC = new org.apache.thrift.protocol.TField("birthdate", org.apache.thrift.protocol.TType.STRUCT, (short)3);
  ...
  private static final org.apache.thrift.protocol.TField FULL_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("full_name", org.apache.thrift.protocol.TType.STRING, (short)5);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    BIRTHDATE((short)3, "birthdate"),
    EMAIL_ADDRESS((short)4, "email_address"),
    FULL_NAME((short)5, "full_name");
  ...
  static {
    ...
    tmpMap.put(_Fields.BIRTHDATE, new org.apache.thrift.meta_data.FieldMetaData("birthdate", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, BirthDate.class)));
  ...
  public static PersonPropertyValue birthdate(BirthDate value) {
    PersonPropertyValue x = new PersonPropertyValue();
    x.setBirthdate(value);
    return x;
  }

  public static PersonPropertyValue email_address(String value) {
    PersonPropertyValue x = new PersonPropertyValue();
    x.setEmail_address(value);
    return x;
  }
  ...
  protected void checkType(_Fields setField, Object value) throws ClassCastException {
    switch (setField) {
      ...
      case BIRTHDATE:
        ...
        throw new ClassCastException("Was expecting value of type BirthDate for field 'birthdate', but got " + value.getClass().getSimpleName());
      case EMAIL_ADDRESS:
        if (value instanceof String) {
          break;
        }
        throw new ClassCastException("Was expecting value of type String for field 'email_address', but got " + value.getClass().getSimpleName());
      case FULL_NAME:
        if (value instanceof String) {
          break;
        }
  ...
  protected Object standardSchemeReadValue(org.apache.thrift.protocol.TProtocol iprot, org.apache.thrift.protocol.TField field) throws org.apache.thrift.TException {
    ...
    if (setField != null) {
      switch (setField) {
        ...
        case BIRTHDATE:
          if (field.type == BIRTHDATE_FIELD_DESC.type) {
            BirthDate birthdate;
            birthdate = new BirthDate();
            birthdate.read(iprot);
            return birthdate;
          } else {
            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
            return null;
        ...
        case EMAIL_ADDRESS:
          if (field.type == EMAIL_ADDRESS_FIELD_DESC.type) {
            String email_address;
            email_address = iprot.readString();
            return email_address;
          } else {
            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
            return null;
  ...
  protected void standardSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    switch (setField_) {
      ...
      case LOCATION:
        ...
        return;
      case BIRTHDATE:
        BirthDate birthdate = (BirthDate)value_;
        birthdate.write(oprot);
        return;
      case EMAIL_ADDRESS:
        String email_address = (String)value_;
        oprot.writeString(email_address);
        return;
      case FULL_NAME:
  ...
  protected org.apache.thrift.protocol.TField getFieldDesc(_Fields setField) {
    switch (setField) {
      ...
      case BIRTHDATE:
        return BIRTHDATE_FIELD_DESC;
      case EMAIL_ADDRESS:
        return EMAIL_ADDRESS_FIELD_DESC;
      case FULL_NAME:
  ...
  public BirthDate getBirthdate() {
    if (getSetField() == _Fields.BIRTHDATE) {
      return (BirthDate)getFieldValue();
    } else {
      throw new RuntimeException("Cannot get field 'birthdate' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }

  public void setBirthdate(BirthDate value) {
    if (value == null) throw new NullPointerException();
    setField_ = _Fields.BIRTHDATE;
    value_ = value;
  }

  public String getEmail_address() {
    if (getSetField() == _Fields.EMAIL_ADDRESS) {
      return (String)getFieldValue();
    } else {
      throw new RuntimeException("Cannot get field 'email_address' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }

  public void setEmail_address(String value) {
    if (value == null) throw new NullPointerException();
    setField_ = _Fields.EMAIL_ADDRESS;
    value_ = value;
  }
  ...
  public boolean isSetBirthdate() {
    return setField_ == _Fields.BIRTHDATE;
  }


  public boolean isSetEmail_address() {
    return setField_ == _Fields.EMAIL_ADDRESS;
  }
