...
public class RelationshipEdge implements org.apache.thrift.TBase<RelationshipEdge, RelationshipEdge._Fields>, java.io.Serializable, Cloneable, Comparable<RelationshipEdge> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RelationshipEdge");
  ...
  static {
    schemes.put(StandardScheme.class, new RelationshipEdgeStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RelationshipEdgeTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RelationshipEdge.class, metaDataMap);
  }
   ...
   */
  public RelationshipEdge(RelationshipEdge other) {
    if (other.isSetId1()) {
  ...
  public RelationshipEdge deepCopy() {
  ...
  public RelationshipEdge setId1(PersonID id1) {
    this.id1 = id1;
    return this;
  }
  ...
  public RelationshipEdge setId2(PersonID id2) {
    this.id2 = id2;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RelationshipEdge)
      return this.equals((RelationshipEdge)that);
    return false;
  }

  public boolean equals(RelationshipEdge that) {
    if (that == null)
      return false;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RelationshipEdge(");
    boolean first = true;
  ...
  private static class RelationshipEdgeStandardSchemeFactory implements SchemeFactory {
    public RelationshipEdgeStandardScheme getScheme() {
      return new RelationshipEdgeStandardScheme();
    }
  }

  private static class RelationshipEdgeStandardScheme extends StandardScheme<RelationshipEdge> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RelationshipEdge struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RelationshipEdge struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class RelationshipEdgeTupleSchemeFactory implements SchemeFactory {
    public RelationshipEdgeTupleScheme getScheme() {
      return new RelationshipEdgeTupleScheme();
    }
  }

  private static class RelationshipEdgeTupleScheme extends TupleScheme<RelationshipEdge> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RelationshipEdge struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RelationshipEdge struct) throws org.apache.thrift.TException {
